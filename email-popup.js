...
class EmailPopup {
  constructor(options = {}) {
    ...
    if (!this.publicationId || !this.apiKey) {
      console.error('EmailPopup: Missing credentials');
      return;
    }
        ...
        <div class="email-popup-modal">
          ...
          <div class="email-popup-content" id="emailPopupContent">
            ...
            <form class="email-popup-form" id="emailPopupForm">
              ...
              <button type="submit" class="email-popup-button" id="emailPopupSubmit">Get My Discount Code</button>
            </form>
          </div>
          ...
          <div class="email-popup-success" id="emailPopupSuccess">
            ...
            <p style="font-size: 12px; color: #808080; margin-top: 12px;">Share this code with our sales team before purchase</p>
  ...
  attachEventListeners() {
    ...
    if (overlay) overlay.addEventListener('click', (e) => { if (e.target === overlay) this.closePopup(); });
    if (form) form.addEventListener('submit', (e) => this.handleSubmit(e));
    if (copyBtn) copyBtn.addEventListener('click', () => this.copyCodeToClipboard());
  }
